...
class Root(FloatLayout):
    ...
    def record(self):
            ...
            #print ("What is happening? Will recording ever finish?")
        #widget.disabled = True
        if 'stop_listening' not in globals():
            global stop_listening
            stop_listening = 'blargh' #holder
        #audio capture
        #with m as source:
        ...
        if ('stop_listening' in globals()) and isinstance(stop_listening, str):
    ...
    outputsize = '15dp'
    def changeSize(self):
        num = int(self.outputsize[0:1])
        num += 5
        self.outputsize = str(num) + 'dp'
